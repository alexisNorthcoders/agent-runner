...
function describeCronOutcome(o) {
  ...
  switch (o.kind) {
    ...
    case 'ran': {
      const label = { progress: 'made progress', no_progress: 'no lasting progress', prep_failed: 'issue fetch or git prep failed', failed: 'failed', timeout: 'timed out', no_changes: 'made no changes', merge_retry: 'merge retried next tick' }[o.result] ?? o.result;
